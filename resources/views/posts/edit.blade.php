    ...
    <div class="container">
        <div class="col-md-6 mt-5 offset-3">
            <form method="post" action="{{ route('posts.update',$post->id) }}" id="form">
                ...
                <div class="mb-3">
                    <label>Email</label>
                    <input name="title" class="form-control" placeholder="title" data-parsley-type="name" type="text" value="{{ $post->title }}">
                </div>
                <div class="mb-3">
                    <label>Description</label>
                    <textarea rows="" class="form-control" cols="" name="description" placeholder="description">{{ $post->description }}</textarea>
                </div>
                <div class="mb-3">
                    <label>Publish</label>
